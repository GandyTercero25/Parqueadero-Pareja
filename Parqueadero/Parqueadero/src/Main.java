        ...
        do {
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    System.out.print("Ingrese la hora de salida (entre 6 y 21): ");
                    int horaSalida = scanner.nextInt();
                    parqueadero.sacarCarro(placaSalida, horaSalida);
                    break;
                case 3:
                    double ingresosTotales = parqueadero.calcularIngresosTotales();
                ...
                case 4:
                    ...
                    break;
                case 5:
                    // Lógica para avanzar el reloj del parqueadero (si se implementa)
                    break;
                case 6:
